    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">{items.length} câu hỏi</p>
        </div>
      ...
      <AdminSearchInput value={search} onChange={setSearch} placeholder="Tìm theo answer hoặc prompt..." className="mb-6" />
