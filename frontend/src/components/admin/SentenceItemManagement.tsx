    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">{items.length} câu</p>
        </div>
      ...
      <AdminSearchInput value={search} onChange={setSearch} placeholder="Tìm theo nội dung câu..." className="mb-6" />
